          ...
          <div className="border-4 border-dark-900 bg-white">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="border-2 border-dark-900 p-4 bg-white">
                ...
                <div className="space-y-1">
                  <p className="text-xs text-dark-700">• Penn Electric Racing (Driver Interface and Vehicle Dynamics Engineer)</p>
                  <p className="text-xs text-dark-700">• M&T Innovation Fund (Co-leader and Analyst)</p>
